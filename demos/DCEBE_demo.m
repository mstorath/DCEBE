% the script estimates the bolus arrival times for a series of DCE-MRI
% signals separately
...
% estimate the BAT index for all signals (columns of y)
BAT_est_idx = DCEBE_estimateBAT(y);
